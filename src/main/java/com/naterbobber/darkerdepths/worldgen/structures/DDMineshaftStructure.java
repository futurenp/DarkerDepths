...
public class DDMineshaftStructure extends Structure {
    ...
    public enum Type implements StringRepresentable {
        ...
        private final RegistryObject<? extends Block> fenceHolder;

        Type(String name, RegistryObject<? extends Block> woodBlock, RegistryObject<? extends Block> planksBlock, RegistryObject<? extends Block> fenceBlock) {
            this.name = name;
