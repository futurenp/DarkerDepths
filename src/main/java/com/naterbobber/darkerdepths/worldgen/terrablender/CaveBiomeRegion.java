...
public class CaveBiomeRegion extends Region {
    ...
    public void addBiomes(Registry<Biome> registry, Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> mapper)
    {
        ...
        if(DDConfig.USE_DEFAULTS_TERRABLENDER.get()) {
            ...
            this.addBiome(mapper, ClimateParamsUtil.climateParamsFromConfig(DDConfig.GLOWSHROOM_FOREST_CLIMATE),
                    DDResourceKeys.Biomes.GLOWSHROOM_FOREST);

            this.addBiome(mapper, ClimateParamsUtil.climateParamsFromConfig(DDConfig.MOLTEN_CAVERN_CLIMATE),
                    DDResourceKeys.Biomes.MOLTEN_CAVERN);

            this.addBiome(mapper, ClimateParamsUtil.climateParamsFromConfig(DDConfig.SANDY_CATACOMBS_CLIMATE),
                    DDResourceKeys.Biomes.SANDY_CATACOMBS);
        }
    }
}