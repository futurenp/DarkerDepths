...
//            DDBlocks.DUSKROCK.get().defaultBlockState(),
    ...
    public static void bootstrap(BootstapContext<ConfiguredFeature<?, ?>> context) {
        ...
        FeatureUtils.register(context, GRIME_VEGETATION, Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(
                new WeightedStateProvider(
                        SimpleWeightedRandomList.<BlockState>builder()
                                .add(DDBlocks.GLOWSHROOM.get().defaultBlockState().setValue(DDBlockStateProperties.GLOWSHROOM_CLUSTERS, 1), 4)
                                .add(DDBlocks.GLOWSHROOM.get().defaultBlockState().setValue(DDBlockStateProperties.GLOWSHROOM_CLUSTERS, 2), 2)
                                .add(DDBlocks.GLOWSHROOM.get().defaultBlockState().setValue(DDBlockStateProperties.GLOWSHROOM_CLUSTERS, 3), 1)
        ...
        FeatureUtils.register(context, ARID_VEGETATION, DDFeatures.RANDOM_FLOOR_PLACEMENT.get(), new RandomFloorPlacementConfig(
                        ...
                        HolderSet.direct(
                                ForgeRegistries.BLOCKS.getHolder(DDBlocks.ARIDROCK.get()).orElseThrow(),
                                ForgeRegistries.BLOCKS.getHolder(DDBlocks.DUSKROCK.get()).orElseThrow(),
                                ForgeRegistries.BLOCKS.getHolder(Blocks.PACKED_MUD).orElseThrow()
                        ),
                        15,
                        4,
                        3,
        ...
        FeatureUtils.register(context, DARKSLATE_VEGETATION, DDFeatures.RANDOM_FLOOR_PLACEMENT.get(), new RandomFloorPlacementConfig(
                        ...
                        HolderSet.direct(ForgeRegistries.BLOCKS.getHolder(DDBlocks.DARKSLATE.get()).orElseThrow()),
                        10,
                        4,
                        2,
                        1
