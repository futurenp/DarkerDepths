...
public class DDPlacedFeatures {
    public static void bootstrap(BootstrapContext<PlacedFeature> context) {
        ...
        PlacementUtils.register(context, LARGE_MOLTEN_PILLAR, lookup.getOrThrow(DDResourceKeys.ConfiguredFeatures.LARGE_MOLTEN_PILLAR), CountPlacement.of(UniformInt.of(10, 48)), InSquarePlacement.spread(), PlacementUtils.RANGE_BOTTOM_TO_MAX_TERRAIN_HEIGHT, BiomeFilter.biome());
