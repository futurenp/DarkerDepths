...
public class DDPlacedFeatures {
    public static void bootstrap(BootstrapContext<PlacedFeature> context) {
        ...
        PlacementUtils.register(context, SCORCHER_PLACER, lookup.getOrThrow(DDResourceKeys.ConfiguredFeatures.SCORCHER_PLACER), List.of(CountPlacement.of(6), InSquarePlacement.spread(), HeightRangePlacement.of(VeryBiasedToBottomHeight.of(VerticalAnchor.bottom(), VerticalAnchor.belowTop(32), 32)), RarityFilter.onAverageOnceEvery(16), EnvironmentScanPlacement.scanningFor(Direction.DOWN, BlockPredicate.solid(), BlockPredicate.ONLY_IN_AIR_PREDICATE, 32), BiomeFilter.biome()));
        ...
        PlacementUtils.register(context, CRYSTAL_HUSK_ORE, lookup.getOrThrow(DDResourceKeys.ConfiguredFeatures.CRYSTAL_HUSK_ORE), CountPlacement.of(256), InSquarePlacement.spread(), PlacementUtils.RANGE_BOTTOM_TO_MAX_TERRAIN_HEIGHT, BiomeFilter.biome());
        ...
        PlacementUtils.register(context, MAGMA_DISK, lookup.getOrThrow(DDResourceKeys.ConfiguredFeatures.MAGMA_DISK), CountPlacement.of(45), InSquarePlacement.spread(), PlacementUtils.RANGE_BOTTOM_TO_MAX_TERRAIN_HEIGHT, EnvironmentScanPlacement.scanningFor(Direction.DOWN, BlockPredicate.solid(), BlockPredicate.matchesBlocks(Blocks.AIR, Blocks.CAVE_AIR, Blocks.LAVA), 16));
