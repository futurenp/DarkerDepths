...
public class DDPlacedFeatures {
    public static void bootstrap(BootstrapContext<PlacedFeature> context) {
        ...
        PlacementUtils.register(context, LARGE_MOLTEN_PILLAR, lookup.getOrThrow(DDResourceKeys.ConfiguredFeatures.LARGE_MOLTEN_PILLAR), CountPlacement.of(UniformInt.of(32, 64)), InSquarePlacement.spread(), PlacementUtils.RANGE_BOTTOM_TO_MAX_TERRAIN_HEIGHT, BiomeFilter.biome());
        PlacementUtils.register(context, SCORCHER_PLACER, lookup.getOrThrow(DDResourceKeys.ConfiguredFeatures.SCORCHER_PLACER), List.of(CountPlacement.of(8), InSquarePlacement.spread(), PlacementUtils.RANGE_BOTTOM_TO_MAX_TERRAIN_HEIGHT, RarityFilter.onAverageOnceEvery(12), EnvironmentScanPlacement.scanningFor(Direction.DOWN, BlockPredicate.solid(), BlockPredicate.ONLY_IN_AIR_PREDICATE, 32), BiomeFilter.biome()));
        PlacementUtils.register(context, DARKSLATE_PLACEMENT, lookup.getOrThrow(DDResourceKeys.ConfiguredFeatures.DARKSLATE_PLACEMENT), CountPlacement.of(0), InSquarePlacement.spread(), PlacementUtils.RANGE_BOTTOM_TO_MAX_TERRAIN_HEIGHT, BiomeFilter.biome());
        PlacementUtils.register(context, DARKSLATE_VEGETATION, lookup.getOrThrow(DDResourceKeys.ConfiguredFeatures.DARKSLATE_VEGETATION), CountPlacement.of(175), InSquarePlacement.spread(), PlacementUtils.RANGE_BOTTOM_TO_MAX_TERRAIN_HEIGHT, BiomeFilter.biome());
        ...
        PlacementUtils.register(context, CATACOMBS_LAYERED_PLACEMENT, lookup.getOrThrow(DDResourceKeys.ConfiguredFeatures.CATACOMBS_LAYERED_PLACEMENT), CountPlacement.of(20), InSquarePlacement.spread(), PlacementUtils.RANGE_BOTTOM_TO_MAX_TERRAIN_HEIGHT, BiomeFilter.biome());
        ...
        PlacementUtils.register(context, CRYSTAL_HUSK_ORE, lookup.getOrThrow(DDResourceKeys.ConfiguredFeatures.CRYSTAL_HUSK_ORE), CountPlacement.of(100), InSquarePlacement.spread(), PlacementUtils.RANGE_BOTTOM_TO_MAX_TERRAIN_HEIGHT, BiomeFilter.biome());
        ...
        PlacementUtils.register(context, MAGMA_DISK, lookup.getOrThrow(DDResourceKeys.ConfiguredFeatures.MAGMA_DISK), CountPlacement.of(30), InSquarePlacement.spread(), PlacementUtils.RANGE_BOTTOM_TO_MAX_TERRAIN_HEIGHT, EnvironmentScanPlacement.scanningFor(Direction.DOWN, BlockPredicate.solid(), BlockPredicate.matchesBlocks(Blocks.AIR, Blocks.CAVE_AIR, Blocks.LAVA), 8));
        ...
        PlacementUtils.register(context, ARID_SURFACE, lookup.getOrThrow(DDResourceKeys.ConfiguredFeatures.ARID_SURFACE), CountPlacement.of(UniformInt.of(140, 200)), InSquarePlacement.spread(), PlacementUtils.RANGE_BOTTOM_TO_MAX_TERRAIN_HEIGHT, BiomeFilter.biome());
        ...
        PlacementUtils.register(context, ARID_VEGETATION, lookup.getOrThrow(DDResourceKeys.ConfiguredFeatures.ARID_VEGETATION), CountPlacement.of(175), InSquarePlacement.spread(), PlacementUtils.RANGE_BOTTOM_TO_MAX_TERRAIN_HEIGHT, BiomeFilter.biome());
        ...
        PlacementUtils.register(context, PETRIFIED_ROOTS, lookup.getOrThrow(DDResourceKeys.ConfiguredFeatures.PETRIFIED_ROOTS), CountPlacement.of(256), InSquarePlacement.spread(), PlacementUtils.RANGE_BOTTOM_TO_MAX_TERRAIN_HEIGHT, EnvironmentScanPlacement.scanningFor(Direction.UP, BlockPredicate.solid(), BlockPredicate.ONLY_IN_AIR_PREDICATE, 12), RandomOffsetPlacement.vertical(ConstantInt.of(-1)), BiomeFilter.biome());
    }
}
