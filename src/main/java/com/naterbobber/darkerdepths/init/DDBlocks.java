...
public class DDBlocks {
    ...
    public static final DeferredBlock<VerticalSlabBlock> PETRIFIED_VERTICAL_SLAB = registerCompatBlock("quark", "petrified_vertical_slab",
    ...
    public static final DeferredBlock<VerticalSlabBlock> ARIDROCK_VERTICAL_SLAB = registerCompatBlock("quark", "aridrock_vertical_slab",
    ...
    public static final DeferredBlock<SlabBlock> POLISHED_ARIDROCK_SLAB = registerBlock("polished_aridrock_slab",
            () -> new SlabBlock(ARIDROCK_PROPERTIES));
    public static final DeferredBlock<VerticalSlabBlock> POLISHED_ARIDROCK_VERTICAL_SLAB = registerCompatBlock("quark", "polished_aridrock_vertical_slab",
            () -> new VerticalSlabBlock(ARIDROCK_PROPERTIES));
    ...
    public static final DeferredBlock<VerticalSlabBlock> ARIDROCK_BRICKS_VERTICAL_SLAB = registerCompatBlock("quark", "aridrock_bricks_vertical_slab",
    ...
    public static final DeferredBlock<VerticalSlabBlock> DUSKROCK_VERTICAL_SLAB = registerCompatBlock("quark", "duskrock_vertical_slab",
    ...
    public static final DeferredBlock<VerticalSlabBlock> POLISHED_DUSKROCK_VERTICAL_SLAB = registerCompatBlock("quark", "polished_duskrock_vertical_slab",
    ...
    public static final DeferredBlock<SlabBlock> DUSKROCK_BRICKS_SLAB = registerBlock("duskrock_bricks_slab",
            () -> new SlabBlock(DUSKROCK_BRICKS_PROPERTIES));
    public static final DeferredBlock<VerticalSlabBlock> DUSKROCK_BRICKS_VERTICAL_SLAB = registerCompatBlock("quark", "duskrock_bricks_vertical_slab",
            () -> new VerticalSlabBlock(DUSKROCK_BRICKS_PROPERTIES));
    ...
    public static final DeferredBlock<StairBlock> DARKSLATE_STAIRS = registerBlock("darkslate_stairs",
            () -> new StairBlock(DARKSLATE.get().defaultBlockState(), DARKSLATE_PROPERTIES));
    public static final DeferredBlock<SlabBlock> DARKSLATE_SLAB = registerBlock("darkslate_slab",
            () -> new SlabBlock(DARKSLATE_PROPERTIES));
    public static final DeferredBlock<VerticalSlabBlock> DARKSLATE_VERTICAL_SLAB = registerCompatBlock("quark", "darkslate_vertical_slab",
            () -> new VerticalSlabBlock(DARKSLATE_PROPERTIES));
    public static final DeferredBlock<WallBlock> DARKSLATE_WALL = registerBlock("darkslate_wall",
    ...
    public static final DeferredBlock<StairBlock> POLISHED_DARKSLATE_STAIRS = registerBlock("polished_darkslate_stairs",
            () -> new StairBlock(POLISHED_DARKSLATE.get().defaultBlockState(), DARKSLATE_PROPERTIES));
    public static final DeferredBlock<SlabBlock> POLISHED_DARKSLATE_SLAB = registerBlock("polished_darkslate_slab",
            () -> new SlabBlock(DARKSLATE_PROPERTIES));
    public static final DeferredBlock<VerticalSlabBlock> POLISHED_DARKSLATE_VERTICAL_SLAB = registerCompatBlock("quark", "polished_darkslate_vertical_slab",
            () -> new VerticalSlabBlock(DARKSLATE_PROPERTIES));
    ...
    public static final DeferredBlock<StairBlock> DARKSLATE_BRICKS_STAIRS = registerBlock("darkslate_bricks_stairs",
            () -> new StairBlock(DARKSLATE_BRICKS.get().defaultBlockState(), DARKSLATE_BRICKS_PROPERTIES));
    public static final DeferredBlock<SlabBlock> DARKSLATE_BRICKS_SLAB = registerBlock("darkslate_bricks_slab",
            () -> new SlabBlock(DARKSLATE_BRICKS_PROPERTIES));
    public static final DeferredBlock<VerticalSlabBlock> DARKSLATE_BRICKS_VERTICAL_SLAB = registerCompatBlock("quark", "darkslate_bricks_vertical_slab",
            () -> new VerticalSlabBlock(DARKSLATE_BRICKS_PROPERTIES));
    public static final DeferredBlock<WallBlock> DARKSLATE_BRICKS_WALL = registerBlock("darkslate_bricks_wall",
    ...
    public static final DeferredBlock<SlabBlock> GRIMESTONE_SLAB = registerBlock("grimestone_slab",
            () -> new SlabBlock(DARKSLATE_PROPERTIES));
    public static final DeferredBlock<VerticalSlabBlock> GRIMESTONE_VERTICAL_SLAB = registerCompatBlock("quark", "grimestone_vertical_slab",
            () -> new VerticalSlabBlock(DARKSLATE_PROPERTIES));
    ...
    public static final DeferredBlock<SlabBlock> POLISHED_GRIMESTONE_SLAB = registerBlock("polished_grimestone_slab",
            () -> new SlabBlock(DARKSLATE_PROPERTIES));
    public static final DeferredBlock<VerticalSlabBlock> POLISHED_GRIMESTONE_VERTICAL_SLAB = registerCompatBlock("quark", "polished_grimestone_vertical_slab",
            () -> new VerticalSlabBlock(DARKSLATE_PROPERTIES));
    ...
    public static final DeferredBlock<SlabBlock> GRIMESTONE_BRICKS_SLAB = registerBlock("grimestone_bricks_slab",
            () -> new SlabBlock(DARKSLATE_BRICKS_PROPERTIES));
    public static final DeferredBlock<VerticalSlabBlock> GRIMESTONE_BRICKS_VERTICAL_SLAB = registerCompatBlock("quark", "grimestone_bricks_vertical_slab",
            () -> new VerticalSlabBlock(DARKSLATE_BRICKS_PROPERTIES));
