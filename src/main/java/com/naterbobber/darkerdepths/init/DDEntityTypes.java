...
public class DDEntityTypes {
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<ScorcherEntity>> SCORCHER = ENTITY_TYPES.register("scorcher",
            () -> EntityType.Builder.of(ScorcherEntity::new, MobCategory.MONSTER).sized(1.0F, 1.0F).eyeHeight(0.5F).clientTrackingRange(8).updateInterval(2).build(DarkerDepths.id("scorcher").toString()));
}
