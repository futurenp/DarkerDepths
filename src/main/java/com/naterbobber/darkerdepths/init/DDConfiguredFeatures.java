...
public class DDConfiguredFeatures {
    ...
    public static final ConfiguredFeature<?, ?> GLOWSHROOM_PATCH = registerConfiguredFeature("glowshroom_patch", DDFeatures.RANDOM_GLOWSHROOM_PATCHES.get().configured(FeatureConfiguration.NONE));
    ...
    public static final ConfiguredFeature<SimpleBlockConfiguration, ?> GEYSER_PLACEMENT = registerConfiguredFeature("geyser_placement", Feature.SIMPLE_BLOCK.configured(new SimpleBlockConfiguration(BlockStateProvider.simple(DDBlocks.GEYSER.get().defaultBlockState()))));
    public static final ConfiguredFeature<VegetationPatchConfiguration, ?> MOLTEN_POOL = registerConfiguredFeature("molten_pool", DDFeatures.LAVA_VEGETATION_PATCH_FEATURE.get().configured(new VegetationPatchConfiguration(BlockTags.BASE_STONE_OVERWORLD.getName(), BlockStateProvider.simple(DDBlocks.ASH_BLOCK.get().defaultBlockState()), GEYSER_PLACEMENT::placed, CaveSurface.FLOOR, ConstantInt.of(1), 0.0F, 5, 0.8F, UniformInt.of(4, 7), 0.3F)));
...
//    public static final ConfiguredFeature<ReplaceListConfig, ?> GRIMESTONE_PLACEMENT = registerConfiguredFeature("grimestone_placement", DDFeatures.REPLACE_LIST.get().configured(new ReplaceListConfig(OVERWORLD_REPLACEABLES, DDBlocks.GRIMESTONE.get().defaultBlockState(), UniformInt.of(6, 7))));
    ...
    public static final ConfiguredFeature<CorrespondentLayersConfig, ?> ARID_SURFACE = registerConfiguredFeature("arid_surface", DDFeatures.CORRESPONDENT.get().configured(new CorrespondentLayersConfig(BlockTags.LUSH_GROUND_REPLACEABLE.getName(), BlockStateProvider.simple(DDBlocks.ARIDROCK.get()), BlockStateProvider.simple(DDBlocks.ARID_DEEPSLATE.get()), ARID_VEGETATION::placed, CaveSurface.FLOOR, ConstantInt.of(1), 0.0F, 5, 0.8F, UniformInt.of(4, 7), 0.3F)));
    public static final ConfiguredFeature<CorrespondentLayersConfig, ?> GRIME_SURFACE = registerConfiguredFeature("grime_surface", DDFeatures.CORRESPONDENT.get().configured(new CorrespondentLayersConfig(BlockTags.LUSH_GROUND_REPLACEABLE.getName(), BlockStateProvider.simple(DDBlocks.MOSSY_GRIMESTONE.get()), BlockStateProvider.simple(DDBlocks.GRIME_DEEPSLATE.get()), GRIME_VEGETATION::placed, CaveSurface.FLOOR, ConstantInt.of(1), 0.0F, 5, 0.8F, UniformInt.of(4, 7), 0.3F)));
