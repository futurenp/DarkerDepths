...
public class DDConfiguredFeatures {
    ...
    public static final Holder<ConfiguredFeature<SimpleBlockConfiguration, ?>> SHALE_VEGETATION = registerConfiguredFeature("shale_vegetation", Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(Blocks.AIR.defaultBlockState(), 60).build())));
    ...
    public static final Holder<ConfiguredFeature<CorrespondentLayersConfig, ?>> SHALE_SURFACE = registerConfiguredFeature("shale_surface", DDFeatures.CORRESPONDENT_LAYER.get(), new CorrespondentLayersConfig(BlockTags.LUSH_GROUND_REPLACEABLE, BlockStateProvider.simple(DDBlocks.SHALE.get()), BlockStateProvider.simple(DDBlocks.SHALE.get()), PlacementUtils.inlinePlaced(SHALE_VEGETATION), CaveSurface.FLOOR, ConstantInt.of(1), 0.0F, 5, 0.8F, UniformInt.of(4, 7), 0.3F));
