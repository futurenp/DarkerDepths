...
public class DDPlacedFeatures {
    ...
    public static final Holder<PlacedFeature> HUGE_GLOWSHROOM = registerPlacedFeature("huge_glowshroom", DDConfiguredFeatures.HUGE_GLOWSHROOM, CountPlacement.of(120), InSquarePlacement.spread(), PlacementUtils.RANGE_BOTTOM_TO_MAX_TERRAIN_HEIGHT, BiomeFilter.biome());
...
//    public static final PlacedFeature ARIDROCK_PLACEMENT = registerPlacedFeature("aridrock_placement", DDConfiguredFeatures.ARIDROCK_PLACEMENT, CountPlacement.of(175), InSquarePlacement.spread(), HeightRangePlacement.uniform(VerticalAnchor.absolute(0), VerticalAnchor.absolute(256))));
//    public static final PlacedFeature LIMESTONE_PLACEMENT = registerPlacedFeature("limestone_placement", DDConfiguredFeatures.LIMESTONE_PLACEMENT, CountPlacement.of(150), InSquarePlacement.spread(), HeightRangePlacement.uniform(VerticalAnchor.bottom(), VerticalAnchor.absolute(0))));
    ...
    public static final Holder<PlacedFeature> SOUL_SOIL = registerPlacedFeature("soul_soil", DDConfiguredFeatures.SOUL_SOIL, CountPlacement.of(125), InSquarePlacement.spread(), PlacementUtils.RANGE_BOTTOM_TO_MAX_TERRAIN_HEIGHT);
