...
import static com.naterbobber.darkerdepths.init.DDResourceKeys.PlacedFeatures.*;
...
public class DDPlacedFeatures {
    public static void bootstrap(BootstrapContext<PlacedFeature> context) {
        ...
        PlacementUtils.register(context, AMBER, lookup.getOrThrow(DDResourceKeys.ConfiguredFeatures.AMBERS_PLACEMENT), CountPlacement.of(UniformInt.of(120, 180)), InSquarePlacement.spread(), PlacementUtils.RANGE_BOTTOM_TO_MAX_TERRAIN_HEIGHT, BiomeFilter.biome());
