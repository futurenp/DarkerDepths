...
public class DDPlacedFeatures {
    ...
    public static final Holder<PlacedFeature> MAGMA_ORE = registerPlacedFeature("magma_ore", DDConfiguredFeatures.MAGMA_ORE, CountPlacement.of(50), InSquarePlacement.spread(), PlacementUtils.RANGE_BOTTOM_TO_MAX_TERRAIN_HEIGHT, BiomeFilter.biome());
    ...
    public static final Holder<PlacedFeature> SHALE_SURFACE = registerPlacedFeature("shale_surface", DDConfiguredFeatures.SHALE_SURFACE, CountPlacement.of(UniformInt.of(192, 256)), InSquarePlacement.spread(), PlacementUtils.RANGE_BOTTOM_TO_MAX_TERRAIN_HEIGHT, BiomeFilter.biome());
