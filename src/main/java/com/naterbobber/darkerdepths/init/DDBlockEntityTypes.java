...
public class DDBlockEntityTypes {
    ...
    public static final RegistryObject<BlockEntityType<ParanoiaAltarBlockEntity>> PARANOIA_ALTAR = BLOCK_ENTITIES.register("paranoia_altar", () -> BlockEntityType.Builder.of(ParanoiaAltarBlockEntity::new, DDBlocks.PARANOIA_ALTAR.get()).build(null));
