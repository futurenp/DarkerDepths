...
public class DDFeatures {
    ...
    public static final DeferredHolder<Feature<?>, ChalkPillarFeature> CHALK_PILLAR = FEATURES.register("chalk_pillar", () -> new ChalkPillarFeature(LargeDripstoneConfiguration.CODEC));
