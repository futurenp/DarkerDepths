...
public class DDItems {
    ...
    public static final RegistryObject<Item> PETRIFIED_BOAT = ITEMS.register("petrified_boat", () -> new DDBoatItem(PetrifiedBoatEntity.BoatType.PETRIFIED, new Item.Properties().stacksTo(1).tab(DarkerDepths.DARKER_DEPTHS)));
    public static final RegistryObject<Item> PETRIFIED_CHEST_BOAT = ITEMS.register("petrified_chest_boat", () -> new DDBoatItem(PetrifiedBoatEntity.BoatType.PETRIFIED, new Item.Properties().stacksTo(1).tab(DarkerDepths.DARKER_DEPTHS)));
