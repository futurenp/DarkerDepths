...
public class BiomeReagentHandler {
    ...
    public static final Climate.Parameter DEEPSLATE_LAYER_BIOME_RANGE = Climate.Parameter.span(1.03f, 1.1f);
    ...
    public static void init(Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> consumer) {
        consumer.accept(Pair.of(Climate.parameters(FULL_RANGE, FULL_RANGE, Climate.Parameter.span(0.6F, 0.7F), Climate.Parameter.span(Climate.Parameter.span(-1.0F, -0.78F), Climate.Parameter.span(-0.78F, -0.375F)), DEEPSLATE_LAYER_BIOME_RANGE, FULL_RANGE, 0.0F), MOLTEN_CAVERN));
