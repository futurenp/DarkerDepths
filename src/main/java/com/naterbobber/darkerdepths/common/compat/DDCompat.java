...
public class DDCompat {
    public static final CompatID QUARK = CompatID.create("quark");
    public static final CompatID NO_MANS_LAND = CompatID.create("nomansland");
    public static final CompatID WOODWORKS = CompatID.create("woodworks");
    ...
    public static final CompatID SABLE = CompatID.create("sable");
}