    ...
    public static void generateOres(FMLLoadCompleteEvent event) {
        for (Biome biome : ForgeRegistries.BIOMES) {
            ...
            if (biome.getCategory() == Biome.Category.NETHER) {
                ...
                stoneGen(biome, 10, 5, 5, 55, OreFeatureConfig.FillerBlockType.NATURAL_STONE, DDBlocks.LIMESTONE.get().getBlock().getDefaultState(), 70);
                magmaGen(biome, 25, 10, 7, 13, OreFeatureConfig.FillerBlockType.NATURAL_STONE, Blocks.MAGMA_BLOCK.getDefaultState(), 15);
                stoneGen(biome, 2, 5, 5, 16, OreFeatureConfig.FillerBlockType.NATURAL_STONE, DDBlocks.ELYTRINE_ORE.get().getBlock().getDefaultState(), 4);

            } else if (biome.getCategory() == Biome.Category.SWAMP) {
                stoneGen(biome, 7, 5, 5, 55, OreFeatureConfig.FillerBlockType.NATURAL_STONE, DDBlocks.SHALE.get().getBlock().getDefaultState(), 80);
                magmaGen(biome, 25, 10, 7, 13, OreFeatureConfig.FillerBlockType.NATURAL_STONE, Blocks.MAGMA_BLOCK.getDefaultState(), 15);
                stoneGen(biome, 2, 5, 5, 16, OreFeatureConfig.FillerBlockType.NATURAL_STONE, DDBlocks.ELYTRINE_ORE.get().getBlock().getDefaultState(), 4);
            } else {
                stoneGen(biome, 2, 5, 5, 40, OreFeatureConfig.FillerBlockType.NATURAL_STONE, DDBlocks.SHALE.get().getBlock().getDefaultState(), 60);
                magmaGen(biome, 25, 10, 7, 13, OreFeatureConfig.FillerBlockType.NATURAL_STONE, Blocks.MAGMA_BLOCK.getDefaultState(), 15);
                stoneGen(biome, 3, 5, 5, 55, OreFeatureConfig.FillerBlockType.NATURAL_STONE, DDBlocks.LIMESTONE.get().getBlock().getDefaultState(), 50);
                stoneGen(biome, 2, 5, 5, 16, OreFeatureConfig.FillerBlockType.NATURAL_STONE, DDBlocks.ELYTRINE_ORE.get().getBlock().getDefaultState(), 4);            }
        }
    }
