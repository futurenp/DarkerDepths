...
public class VanillaBiomeFeatures {
	...
	public static void addAsh(Biome biomeIn) {
		biomeIn.addFeature(GenerationStage.Decoration.UNDERGROUND_DECORATION, Feature.RANDOM_PATCH.withConfiguration(ASH_CONFIG).withPlacement(Placement.CHANCE_RANGE.configure(new ChanceRangeConfig(25, 0, 0, 55))));
