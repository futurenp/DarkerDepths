...
public class WaterCarver extends NoiseCarver {
    private long seed;
    ...
    /**
     * Fuck you blackgear, teach me how to make noise caves AHHHHHHHHHHHHHHHHHHH
     * @param codec
     */

    public WaterCarver(Codec<ProbabilityConfig> codec) {
        super(codec);
    }
