...
public class GlowshroomCaveBiome extends AbstractBiome {@Override
protected Biome.Category category() {
    ...
    protected void ambience(BiomeAmbience.Builder ambience) {
        ambience.setWaterColor(4159204).setWaterFogColor(329011).setFogColor(12638463).build();
    }
    ...
    @Override
    protected void generation(BiomeGenerationSettings.Builder generation) {
