...
public class GlowspursBlock extends Block {
    ...
    public GlowspursBlock(AbstractBlock.Properties properties) {
        super(properties);
        this.setDefaultState(this.stateContainer.getBaseState().with(POWERED, false).with(FACING, Direction.NORTH));
    }
