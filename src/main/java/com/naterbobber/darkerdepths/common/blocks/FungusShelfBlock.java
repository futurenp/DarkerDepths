...
public class FungusShelfBlock extends Block implements IWaterLoggable {
    ...
    public FungusShelfBlock(Properties properties) {
        super(properties);
    ...
    public BlockState getStateForPlacement(BlockItemUseContext context) {
        ...
        for(Direction direction : adirection) {
            if (direction.getAxis().isHorizontal()) {
                blockstate = blockstate.with(FACING, direction.getOpposite()).with(WATERLOGGED, iworldreader.getFluidState(blockpos).getFluid() == Fluids.WATER);
