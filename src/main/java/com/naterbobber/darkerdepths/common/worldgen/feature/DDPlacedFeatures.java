package com.naterbobber.darkerdepths.common.worldgen.feature;
...
import static com.naterbobber.darkerdepths.common.util.DDResourceKeys.PlacedFeatures.*;
...
public class DDPlacedFeatures {
    public static void bootstrap(BootstrapContext<PlacedFeature> context) {
        ...
        PlacementUtils.register(context, SMUSHED_GLOWSHROOM, lookup.getOrThrow(DDResourceKeys.ConfiguredFeatures.SMUSHED_GLOWSHROOM),
                CountPlacement.of(UniformInt.of(52, 72)),
                InSquarePlacement.spread(),
                PlacementUtils.RANGE_BOTTOM_TO_MAX_TERRAIN_HEIGHT,
                EnvironmentScanPlacement.scanningFor(
                        Direction.DOWN,
        ...
        PlacementUtils.register(context, GRIMESTONE_CLIFF, lookup.getOrThrow(DDResourceKeys.ConfiguredFeatures.GRIMESTONE_CLIFF),
                CountPlacement.of(UniformInt.of(24, 36)),
                InSquarePlacement.spread(),
                PlacementUtils.RANGE_BOTTOM_TO_MAX_TERRAIN_HEIGHT,
                EnvironmentScanPlacement.scanningFor(
                        Direction.DOWN,
        ...
        PlacementUtils.register(context, SHELF_GLOWSHROOM, lookup.getOrThrow(DDResourceKeys.ConfiguredFeatures.SHELF_GLOWSHROOM),
                CountPlacement.of(UniformInt.of(16, 22)),
                InSquarePlacement.spread(),
                PlacementUtils.RANGE_BOTTOM_TO_MAX_TERRAIN_HEIGHT,
                BiomeFilter.biome());
        ...
        PlacementUtils.register(context, DARKSLATE_VEGETATION, lookup.getOrThrow(DDResourceKeys.ConfiguredFeatures.DARKSLATE_VEGETATION),
                CountPlacement.of(175),
                InSquarePlacement.spread(),
                PlacementUtils.RANGE_BOTTOM_TO_MAX_TERRAIN_HEIGHT,
                BiomeFilter.biome());

        PlacementUtils.register(context, CATACOMBS_SAND_PLACEMENT, lookup.getOrThrow(DDResourceKeys.ConfiguredFeatures.CATACOMBS_SAND_PLACEMENT),
                CountPlacement.of(48),
                InSquarePlacement.spread(),
                PlacementUtils.RANGE_BOTTOM_TO_MAX_TERRAIN_HEIGHT,
                BiomeFilter.biome());

        PlacementUtils.register(context, CATACOMBS_LAYERED_PLACEMENT, lookup.getOrThrow(DDResourceKeys.ConfiguredFeatures.CATACOMBS_LAYERED_PLACEMENT),
                CountPlacement.of(20),
                InSquarePlacement.spread(),
                PlacementUtils.RANGE_BOTTOM_TO_MAX_TERRAIN_HEIGHT,
                BiomeFilter.biome());

        PlacementUtils.register(context, PETRIFIED_BRANCH, lookup.getOrThrow(DDResourceKeys.ConfiguredFeatures.PETRIFIED_BRANCH),
                CountPlacement.of(150),
                InSquarePlacement.spread(),
                PlacementUtils.RANGE_BOTTOM_TO_MAX_TERRAIN_HEIGHT,
                BiomeFilter.biome());

        PlacementUtils.register(context, CRYSTAL_HUSK_ORE, lookup.getOrThrow(DDResourceKeys.ConfiguredFeatures.CRYSTAL_HUSK_ORE),
                CountPlacement.of(100),
                InSquarePlacement.spread(),
                PlacementUtils.RANGE_BOTTOM_TO_MAX_TERRAIN_HEIGHT,
                BiomeFilter.biome());

        PlacementUtils.register(context, MAGMA_ORE, lookup.getOrThrow(DDResourceKeys.ConfiguredFeatures.MAGMA_ORE),
                CountPlacement.of(30),
                InSquarePlacement.spread(),
                PlacementUtils.RANGE_BOTTOM_TO_MAX_TERRAIN_HEIGHT,
                BiomeFilter.biome());

        PlacementUtils.register(context, MAGMA_DISK, lookup.getOrThrow(DDResourceKeys.ConfiguredFeatures.MAGMA_DISK),
                CountPlacement.of(30),
                InSquarePlacement.spread(),
                PlacementUtils.RANGE_BOTTOM_TO_MAX_TERRAIN_HEIGHT,
        ...
        PlacementUtils.register(context, ARID_SURFACE, lookup.getOrThrow(DDResourceKeys.ConfiguredFeatures.ARID_SURFACE),
                CountPlacement.of(UniformInt.of(140, 200)),
                InSquarePlacement.spread(),
                PlacementUtils.RANGE_BOTTOM_TO_MAX_TERRAIN_HEIGHT,
                BiomeFilter.biome());

        PlacementUtils.register(context, DARKSLATE_SURFACE, lookup.getOrThrow(DDResourceKeys.ConfiguredFeatures.DARKSLATE_SURFACE),
                CountPlacement.of(UniformInt.of(192, 256)),
                InSquarePlacement.spread(),
                PlacementUtils.RANGE_BOTTOM_TO_MAX_TERRAIN_HEIGHT,
                BiomeFilter.biome());

        PlacementUtils.register(context, ARID_VEGETATION, lookup.getOrThrow(DDResourceKeys.ConfiguredFeatures.ARID_VEGETATION),
                CountPlacement.of(175),
                InSquarePlacement.spread(),
                PlacementUtils.RANGE_BOTTOM_TO_MAX_TERRAIN_HEIGHT,
        ...
        PlacementUtils.register(context, DUSKROCK_ORE, lookup.getOrThrow(DDResourceKeys.ConfiguredFeatures.DUSKROCK_ORE),
        ...
        PlacementUtils.register(context, CATACOMBS_LAVA_LINING, lookup.getOrThrow(DDResourceKeys.ConfiguredFeatures.CATACOMBS_LAVA_LINING), List.of(
                ...
                InSquarePlacement.spread(),
                HeightRangePlacement.uniform(VerticalAnchor.absolute(-63), VerticalAnchor.absolute(-1)),
                BlockPredicateFilter.forPredicate(BlockPredicate.not(BlockPredicate.matchesBlocks(Blocks.AIR))),
                BiomeFilter.biome()));
