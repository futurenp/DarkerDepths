...
import com.naterbobber.darkerdepths.common.worldgen.retrogen.processors.HeatPropagationProcessor;
...
public class ChunkPostProcessManager {
    ...
    public static void handleChunkLoadData(ServerLevel level, ChunkPos pos, CompoundTag data) {
        if (DDConfig.CONFIG.DISABLE_HEATABLE_BLOCK_BAKING.get()) return;
