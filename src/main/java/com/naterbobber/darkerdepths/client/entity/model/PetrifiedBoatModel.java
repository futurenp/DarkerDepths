...
@OnlyIn(Dist.CLIENT)
public class PetrifiedBoatModel extends SegmentedModel<PetrifiedBoatEntity> {
	...
	public void setRotationAngles(PetrifiedBoatEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
	...
	protected void func_228244_a_(PetrifiedBoatEntity p_228244_1_, int p_228244_2_, float p_228244_3_) {
