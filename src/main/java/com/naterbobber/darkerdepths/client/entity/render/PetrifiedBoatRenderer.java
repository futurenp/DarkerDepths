...
@OnlyIn(Dist.CLIENT)
public class PetrifiedBoatRenderer extends EntityRenderer<PetrifiedBoatEntity> {
	private static final ResourceLocation BOAT_TEXTURE = new ResourceLocation(DarkerDepths.MODID, "textures/entity/boat/petrified.png");
	protected final PetrifiedBoatModel modelBoat = new PetrifiedBoatModel();

	public PetrifiedBoatRenderer(EntityRendererManager renderManager) {
		super(renderManager);
		this.shadowSize = 0.8f;
	}

	@Override
	public void render(PetrifiedBoatEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn) {
		matrixStackIn.push();
	...
	@Override
	public ResourceLocation getEntityTexture(PetrifiedBoatEntity entity) {
		return BOAT_TEXTURE;
	}
