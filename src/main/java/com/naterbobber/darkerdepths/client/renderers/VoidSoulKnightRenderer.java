...
@OnlyIn(Dist.CLIENT)
public class VoidSoulKnightRenderer extends MobRenderer<VoidSoulKnight, VoidSoulKnightModel<VoidSoulKnight>> {
    ...
    @Override
    public ResourceLocation getTextureLocation(VoidSoulKnight p_114482_) {
        return TEXTURE;
    }
}
