...
public class PetrifiedBoatRenderer extends EntityRenderer<PetrifiedBoatEntity> {
    private final Map<PetrifiedBoatEntity.BoatType, Pair<ResourceLocation, BoatModel>> boatResources;
    ...
    public static ModelLayerLocation createBoatLayerLocation(PetrifiedBoatEntity.BoatType type) {
        return new ModelLayerLocation(new ResourceLocation(DarkerDepths.MODID, "boat/" + type.getName()), "main");
    }

    @Override
    public void render(PetrifiedBoatEntity entity, float yaw, float partialTicks, PoseStack matrixStack, MultiBufferSource bufferSource, int packedLight) {
    ...
    @Override
    public ResourceLocation getTextureLocation(PetrifiedBoatEntity entity) {
