...
//    @Override
//    public void renderFinal(PoseStack poseStack, GlowshroomMonsterEntity animatable, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
...
//                    animatable.getCommandSenderWorld().addParticle(ParticleTypes.SWEEP_ATTACK, particlePos.x(), particlePos.y(), particlePos.z(), rand.nextDouble() - 0.5, -rand.nextDouble(), rand.nextDouble() - 0.5);
//                });
//            }
//        }
//
