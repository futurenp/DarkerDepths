...
public class DDCarvers {
	...
	public static final RegistryObject<WorldCarver<ProbabilityConfig>> LARGE_CAVE 		= CARVER.register("large_cave", () -> new LargeCaveCarver(ProbabilityConfig.field_236576_b_, 60));
