...
public class DDItems {
	...
	public static final RegistryObject<Item> GLOWSHROOM_CAP		= HELPER.registerItem("glowshroom_cap", () -> new GlowshroomCap(new Item.Properties().group(DarkerDepths.DARKER_DEPTHS)));
