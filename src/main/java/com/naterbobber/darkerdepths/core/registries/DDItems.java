...
public class DDItems {
	...
	//food
	public static final RegistryObject<Item> GLOWSHROOM_STEW	= HELPER.registerItem("glowshroom_stew", () -> new SoupItem(new Item.Properties().maxStackSize(1).food(new Food.Builder().hunger(6).saturation(0.6F).build())));
