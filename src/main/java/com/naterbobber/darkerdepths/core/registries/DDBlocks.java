...
public class DDBlocks {
	...
	//grimestone
	public static final RegistryObject<Block> GRIMESTONE						= HELPER.registerBlock("grimestone", () -> new GrimestoneBlock(AbstractBlock.Properties.create(Material.ROCK).hardnessAndResistance(1.5F, 6.0F).setRequiresTool().harvestTool(ToolType.PICKAXE)), DarkerDepths.DARKER_DEPTHS);
