...
public class DDBlocks {
	...
	public static final RegistryObject<Block> AMBER 					= HELPER.createBlock("amber", () -> new AmberGemStoneBlock(AbstractBlock.Properties.create(DDMaterial.AMBER).hardnessAndResistance(1.0f).harvestTool(ToolType.PICKAXE).harvestLevel(2).sound(SoundType.GLASS).setLightLevel(value -> 7)), DarkerDepths.DARKER_DEPTHS);
