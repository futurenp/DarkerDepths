...
public class DDBlocks {
	...
	public static final RegistryObject<Block> WEATHERED_SANDSTONE		= HELPER.createBlock("weathered_sandstone", () -> new Block(Block.Properties.create(Material.ROCK, MaterialColor.SAND).hardnessAndResistance(1.5f, 6.0f).harvestTool(ToolType.PICKAXE).sound(SoundType.STONE)), DarkerDepths.DARKER_DEPTHS);
