...
public class DDFeatures {
	...
	public static final RegistryObject<Feature<NoFeatureConfig>> SHELF_FEATURE							= HELPER.createFeature("shelf_feature", () -> new ShelfFeature(NoFeatureConfig.field_236558_a_));
