    ...
    public void generate(BiConsumer<ResourceLocation, LootTable.Builder> consumer) {
        LootTable.Builder catacombs_chest_standard = LootTable.lootTable()
                .withPool(LootPool.lootPool()
                        .setRolls(UniformGenerator.between(5.0F, 12.0F))
                        .add(LootItem.lootTableItem(DDItems.ROPE.get()).setWeight(10)
                        ...
                        .add(LootItem.lootTableItem(DDItems.VOID_SOUL_TORCH.get()).setWeight(6))
                        ...
                        .add(LootItem.lootTableItem(Items.GOLD_NUGGET).setWeight(5)
                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 3.0F))))
                        .add(LootItem.lootTableItem(DDBlocks.VOID_SOUL_JAR.get().asItem()).setWeight(4))
        ...
        LootTable.Builder catacombs_chest_treasure = LootTable.lootTable()
                .withPool(LootPool.lootPool()
                        ...
                        .add(LootItem.lootTableItem(DDItems.AMBER.get()).setWeight(8)
                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 4.0F))))
                        .add(LootItem.lootTableItem(DDItems.ROPE.get()).setWeight(7)
                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 8.0F))))
                        .add(LootItem.lootTableItem(Items.IRON_INGOT).setWeight(8)
                        ...
                        .add(LootItem.lootTableItem(DDItems.VOID_SOUL_REQUIEM.get()).setWeight(5))
                        .add(LootItem.lootTableItem(DDBlocks.CRYSTAL_MELON.get().asItem()).setWeight(4))
