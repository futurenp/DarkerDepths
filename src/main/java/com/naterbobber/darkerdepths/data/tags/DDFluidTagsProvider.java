...
public class DDFluidTagsProvider extends FluidTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider provider) {
        ...
        this.tag(DDTags.Fluids.HEAT_PROVIDER)
                .addOptionalTag(DDTags.Fluids.VERY_HIGH_HEAT.location())
                .addOptionalTag(DDTags.Fluids.HIGH_HEAT.location())
                .addOptionalTag(DDTags.Fluids.MEDIUM_HEAT.location())
                .addOptionalTag(DDTags.Fluids.LOW_HEAT.location());
    }
}
