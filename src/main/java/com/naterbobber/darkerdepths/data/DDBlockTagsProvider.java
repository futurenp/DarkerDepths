...
public class DDBlockTagsProvider extends BlockTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider provider) {
        ...
        this.tag(BlockTags.BASE_STONE_OVERWORLD).add(DDBlocks.DARKSLATE.get(), DDBlocks.ARIDROCK.get(), DDBlocks.LIMESTONE.get(), DDBlocks.GRIMESTONE.get());
        this.tag(BlockTags.WALLS).add(DDBlocks.DARKSLATE_WALL.get(), DDBlocks.ARIDROCK_WALL.get(), DDBlocks.LIMESTONE_WALL.get(), DDBlocks.GRIMESTONE_WALL.get(), DDBlocks.DARKSLATE_BRICKS_WALL.get(), DDBlocks.ARIDROCK_BRICKS_WALL.get(), DDBlocks.LIMESTONE_BRICKS_WALL.get(), DDBlocks.GRIMESTONE_BRICKS_WALL.get());
