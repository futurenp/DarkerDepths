...
public class DDBlockTagsProvider extends BlockTagsProvider {
    ...
    public DDBlockTagsProvider(DataGenerator p_126511_, @Nullable ExistingFileHelper existingFileHelper) {
        super(p_126511_, DarkerDepths.MODID, existingFileHelper);
    }
